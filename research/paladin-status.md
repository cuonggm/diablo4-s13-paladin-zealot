...
- [README](../README.md)
- Liên quan: [Season 13 Overview](season-13-overview.md), [Zealot Zenith Leveling](../builds/zealot-zenith-leveling.md), [Zealot Zenith Fervor](../builds/zealot-zenith-fervor.md), [Testing Log](../notes/testing-log.md)
...
| Class resource là `Faith` theo community guide. | Community | Wowhead, Icy Veins | Khi test rotation, theo dõi cảm giác thiếu Faith và cách generate. |
| Class mechanic là `Oaths` với 4 hướng: Zealot, Juggernaut, Judicator, Disciple. | Verified/Community | Blizzard overview xác nhận Oaths; chi tiết số liệu từ cộng đồng | Chọn Oath theo cách chơi, không chỉ theo damage sheet. |

Sources:

- Blizzard - Paladin overview: https://news.blizzard.com/en-gb/article/24244399/wield-divine-might-as-the-paladin
...
| `Oaths` | Verified/Community | Oath định hình build: tốc đánh, tank, mark/detonate, hoặc angelic transformation. |
| `Faith` | Community | Resource chính để xài Core Skill; nếu thiếu Faith thì build sẽ khựng. |

## Oaths

| Oath | Status | Fantasy | Khi nên thử |
|---|---|---|---|
| `Zealot` | Verified/Community | Holy warrior đánh nhanh, tạo Fervor, hợp tốc độ và crit. | Khi muốn leveling/speed farm cảm giác mượt, nhiều hit. |
| `Juggernaut` | Verified/Community | Tank templar, Resolve, shield, size/damage cho skill phòng thủ. | Khi chơi Hardcore, push khó, hoặc muốn Voryn là guardian. |
| `Judicator` | Verified/Community | Judge enemy, detonate bằng Core Skill, tăng damage lên mục tiêu. | Khi muốn bossing hoặc gameplay mark-and-burst. |
| `Disciple` | Verified/Community | Angelic form, Arbiter, skill cooldown và ultimate fantasy. | Khi muốn Holy caster/melee lai, mobility và visual mạnh. |
