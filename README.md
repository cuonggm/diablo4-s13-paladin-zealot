...
| Gặp thuật ngữ lạ như `Faith`, `Fervor`, `War Plans`, `Talisman` | [Basic Terms And Mechanics - Glossary](docs/basic-terms-and-mechanics.md) |
| Vừa đổi build hoặc difficulty | [Testing Log](notes/testing-log.md) |
